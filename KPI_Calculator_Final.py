...
def Hr_info():
    ...
    try:
        ...
        if "no matching sheet found" in str(e):
            messagebox.showwarning("Warning", "Chọn sai file. Không tìm thấy sheet 'KPI'.")
        else:
...
# Add copyright label
copyright_text = "Copyright © by Hau - version 1.0.1"
copyright_label = tk.Label(root, text=copyright_text, font=("Arial", 8), fg="gray", bg='#2C3E50')
